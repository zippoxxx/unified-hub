  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        wave: {
          sidebar: "hsl(var(--wave-sidebar))",
          "sidebar-fg": "hsl(var(--wave-sidebar-foreground))",
          "sidebar-active": "hsl(var(--wave-sidebar-active))",
          "sidebar-hover": "hsl(var(--wave-sidebar-hover))",
          ...
          "bubble-received": "hsl(var(--wave-bubble-received))",
          "input-bg": "hsl(var(--wave-input-bg))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
